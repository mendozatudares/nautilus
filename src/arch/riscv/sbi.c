...
static inline bool_t sbi_ext_present(enum sbi_extension e) {
  return sbi_ext & (1 << e);
}
...
void sbi_init(void) {
  printk("RISCV: SBI spec version %ld impl id %ld version %ld\n",
